...
HALLOWEEN_QUOTE = [
    ...
    "When black cats prowl and pumpkins gleam, may luck be "
    "yours on Halloween", "Halloween wraps fear in innocence, "
...
WOLFENOOT_QUOTE = ["Listen to them — the children of the night. What music they make!",
